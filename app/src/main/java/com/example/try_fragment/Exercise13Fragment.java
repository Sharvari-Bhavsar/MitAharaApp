 ...
 * Use the {@link Exercise13Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Exercise13Fragment extends Fragment {
     ...
     * @return A new instance of fragment Exercise13Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Exercise13Fragment newInstance(String param1, String param2) {
        Exercise13Fragment fragment = new Exercise13Fragment();
    ...
    Button button16,button21,button22,button23,button24;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view= inflater.inflate(R.layout.fragment_exercise13, container, false);
        ...
        button16.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Fragment next5 = new Physical11Fragment();
        ...
        button21.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Fragment next6 = new Physical12Fragment();
                FragmentTransaction fm1 = getActivity().getSupportFragmentManager().beginTransaction();
        ...
        button22.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Fragment next9 = new Physical13Fragment();
                FragmentTransaction fm1 = getActivity().getSupportFragmentManager().beginTransaction();
        ...
        button23.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Fragment next7 = new Physical14Fragment();
                FragmentTransaction fm1 = getActivity().getSupportFragmentManager().beginTransaction();
        ...
        button24.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Fragment next8 = new Physical15Fragment();
                FragmentTransaction fm1 = getActivity().getSupportFragmentManager().beginTransaction();
                fm1.replace(R.id.fragmentContainerView, next8).commit();
            }
        });
        ImageButton imageButton17 =view.findViewById(R.id.imageButton17);
